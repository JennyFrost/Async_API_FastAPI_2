...
@pytest.mark.asyncio
async def test_search(create_index_movies: AsyncElasticsearch):
    es_client: AsyncElasticsearch = await create_index_movies
    ...
    query_data = {'query': 'The Star', 'page_size': 50}
